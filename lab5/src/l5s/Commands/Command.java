package l5s.Commands;

import l5s.Classes.Coordinates;
import l5s.Classes.Label;
import l5s.Classes.MusicBand;
import l5s.Classes.MusicGenre;
import org.w3c.dom.*;
...
//        domXml();
    ...
    public void domXml(){
        ...
        try {
            ...
            Document document = db.parse("D:\\A_itmo\\iProgram\\lab5\\src\\l5s\\musicBands.xml");
...
//            return false;
    ...
    public boolean save() throws IOException {
        ...
        OutputStream f = new FileOutputStream( "D:\\A_itmo\\iProgram\\lab5s\\src\\l5s\\musicBands.xml");
