...
//                }
    ...
    public boolean update_id(String[] values) {
        ...
        if (uname.equals(getUser(user1).getUserId())) {
...
//        MusicBand musicBand = new MusicBand();
    ...
    public boolean save() throws IOException {
        ...
        String xml = "<?xml version=\"1.0\"?>\n" +
                "<MusicBands>\n";
        if (getUser(user1).getUserId().equals(uname)) {
        ...
        OutputStream f = new FileOutputStream("D:\\A_itmo\\iProgram\\lab7s\\Server\\musicBands.xml");
...
//        System.out.println("get:" + getUser(user1).getUserId());
//        return "Id - "+mb.getId()+
//                "\n    Name:"+mb.getName()+
//                "\n    Coordinates:"+mb.getCoordinates()+
//                "\n    CreationDate:"+mb.getCreationDate()+
...
//                "\n    Genre:"+mb.getGenre()+
//                "\n    Label:"+mb.getLabel() +
//                "\n    UserName:"+ getUser(user1).getUserId() + "\n";
//    }
    public String info() {
    ...
    public boolean remove_by_id(Integer id) {
        if (unames.get(id).equals(getUser(user1).getUserId())) {
            int i = 0;
            boolean exist = false;
